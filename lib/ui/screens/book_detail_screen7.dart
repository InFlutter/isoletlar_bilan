...
class BookDetailScreen7 extends StatefulWidget {
  const BookDetailScreen7({Key? key}) : super(key: key);

  @override
  _BookDetailScreen7State createState() => _BookDetailScreen7State();
}

class _BookDetailScreen7State extends State<BookDetailScreen7> {
