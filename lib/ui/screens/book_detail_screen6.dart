...
class BookDetailScreen6 extends StatefulWidget {
  const BookDetailScreen6({Key? key}) : super(key: key);

  @override
  _BookDetailScreen6State createState() => _BookDetailScreen6State();
}

class _BookDetailScreen6State extends State<BookDetailScreen6> {
