...
class BookDetailScreen9 extends StatefulWidget {
  const BookDetailScreen9({Key? key}) : super(key: key);

  @override
  _BookDetailScreen9State createState() => _BookDetailScreen9State();
}

class _BookDetailScreen9State extends State<BookDetailScreen9> {
