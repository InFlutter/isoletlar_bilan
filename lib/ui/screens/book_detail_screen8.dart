...
class BookDetailScreen8 extends StatefulWidget {
  const BookDetailScreen8({Key? key}) : super(key: key);

  @override
  _BookDetailScreen8State createState() => _BookDetailScreen8State();
}

class _BookDetailScreen8State extends State<BookDetailScreen8> {
